...
exports.BaseResponseFormatter = void 0;
const rxjs_1 = require("rxjs");
const InjecTable_decorator_1 = __importDefault(require("../core/decorators/InjecTable.decorator"));
let BaseResponseFormatter = class BaseResponseFormatter {
    intercept(context, next) {
        return next.hanlde().pipe((0, rxjs_1.map)((data) => {
            return {
                message: "Thành công",
                data,
                statusCode: 200,
...
exports.BaseResponseFormatter = BaseResponseFormatter = __decorate([
